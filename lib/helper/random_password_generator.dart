...
class RandomPasswordGenerator {
  ...
  String randomPassword(
    ...
    _result += _lowerCaseLetters[randomInt];
    randomInt = Random.secure().nextInt(_upperCaseLetters.length);
    _result += _upperCaseLetters[randomInt];
    randomInt = Random.secure().nextInt(_allowedChars.length);
    _result += _allowedChars[randomInt];
    randomInt = Random.secure().nextInt(_numbers.length);
    _result += _numbers[randomInt];
    randomInt = Random.secure().nextInt(_special.length);
    _result += _special[randomInt];
